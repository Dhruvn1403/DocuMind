...
export async function uploadFilePathToS3(filePath, originalName, metaData, folder = "bandhucare_test", deleteFile = true) {
...
export async function uploadImageToAwsS3(filePath, originalName, folder = "uploads/images") {
    if (!fs.existsSync(filePath)) {
...
//# sourceMappingURL=upload.functions.js.map